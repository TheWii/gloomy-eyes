...
execute store result storage thewii:vp_library/temp pose[0] float 0.001 run scoreboard players get $pose twvp.temp

data modify entity @s Pose.Head set from storage thewii:vp_library/temp pose


# Update comparable score
scoreboard players operation @s twge.pose = $pose twvp.temp