...
scoreboard players set #eyes.default_summon_chance twge.data 0

# Increase the chance by this value every failure (100% = 100,000)
scoreboard players set #eyes.summon_chance_increase twge.data 20

# Neutral time after being haunted (in seconds)
scoreboard players set #eyes.haunted_neutral_time twge.data 60
